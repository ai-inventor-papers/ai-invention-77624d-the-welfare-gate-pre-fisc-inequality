...
### [1] SYSTEM-USER prompt · 2026-09-05 12:29:17 UTC
...
abstract: >-
  The literature on democratic erosion in the twenty-first century holds two contradictory accounts. The materialist account
  finds that income inequality is among the strongest predictors of democratic decline in a global sample of uninterrupted
  democracies [1]. The coalitional account argues, from close case comparison, that economic grievances did not systematically
  separate post-1990 backsliders from survivors [2]. This paper argues that the contradiction is unresolved for a structural
  reason: neither account tests the conditioning structure, and the statistical account's treatment is entangled with the
  very institution the gate hypothesis implicates. Disposable-income inequality is post-fisc, and fiscal systems that compress
  it are larger where welfare states are larger, so a gate estimated on the disposable Gini cannot separate institutional
  transmission from arithmetic filtering. We register a design that corrects both problems: the treatment is pre-fisc, the
  World Inequality Database pre-tax top-10 percent income share, with the market-income Gini secondary. The fiscal filter
  is measured directly as the market-minus-disposable Gini gap, converting the entanglement into the test of the stabilization
  mechanism. Among post-1990 democratizers whose transition began between 1989 and 1998, the hypothesis is that market-inequality
  surges erode the V-Dem Liberal Democracy Index three to five years later only where universal public health and education
  services built in the first democratic decade are thin. The gate is identified off deviations from welfare-specific trends,
  with estimators built for differential treatment timing, a fixed roster with a documented coverage matrix, and a simulation-based
  minimum-detectable-effect analysis. Confirmation and disconfirmation criteria are fixed ex ante, with a primary-specification
  significance rule and a five-of-seven robustness threshold. The design is built so the test can adjudicate between unconditional
  materialist, purely coalitional, and institutionally gated accounts.
paper_text: |
  # The Welfare Gate: Pre-Fisc Inequality, Universal Public Services, and Democratic Resilience in Post-1990 Democratizers
...
summary: >-
  A pre-registered research design adjudicating among materialist, coalitional, and institutionally gated accounts of post-1990
  democratic erosion. The treatment is pre-fisc market inequality (WID pre-tax top-10 percent income share; market Gini secondary),
  measured against a pre-determined welfare gate of public health and education spending built in the first democratic decade,
  with the market-minus-disposable Gini gap directly measuring the automatic-stabilization leg. The gate is identified off
  welfare-specific trends with staggered event-study estimators built for differential timing; the cohort is capped at 1989-1998
  transitions so welfare precedes the 2008 crisis and the 2010-2022 resilience window; a fixed roster, coverage matrix, legacy-instrument
  2SLS, exogeneity probes, and a simulation-based minimum-detectable-effect analysis are deposited in a timestamped registry.
  Confirmation requires a significant pre-fisc-inequality-by-welfare interaction with the marginal-effect pattern in the primary
  specification and at least 5 of 7 robustness cells; disconfirmation adjudicates toward unconditional materialist or purely
  coalitional accounts. No models have been estimated: the paper is an honest pre-registration, and a null result is itself
  the contribution.
</paper_text>
...
Register note: all four papers write in short, declarative sentences with an interquartile
range well above 8 words; almost no hedging in the results and methods (hedges cluster in the
theory and caveat passages); first person is "we/our" in the empirical work and avoided in the
theory and discussion passages of the political-science papers; citation density is high
(nearly every sentence carries a bracketed citation or two, sometimes interrupting the
sentence); numbers are stated plainly with units and referents ("16 percent increase in tax
revenues as a fraction of GDP", "Gini = 38.4 in 2017"); claims about causality are cautious
("association", "we uncover patterns", "is unlikely to be a case of reverse causation") but
claims about measurement and descriptives are unhedged. Em dashes are rare in all four.

---

## 1. Rau and Stokes (2025), PNAS 122(1): e2422543121 — "Income inequality and the erosion of democracy in the twenty-first century"
URL: https://www.pnas.org/doi/10.1073/pnas.2422543121 (open-access PDF: https://susan-stokes.com/files/pnas2025.pdf)
...
### First paragraphs of the introduction (verbatim)
"Classifying political regimes has never been more difﬁcult. Most regimes in the world hold de-jure multi-party elections with universal suffrage. In some countries, elections ensure that political rulers are—at least somewhat—accountable to the electorate whereas in others they are a mere window dressing exercise for authoritarian politics. Therefore, we need to base regime classification on the de-facto implementation of democratic institutions and processes. This is key to being able to make a meaningful distinction between electoral democracies and electoral autocracies. Such data is provided by the Varieties of Democracy (V-Dem) Project, which covers 177 countries from 1900 to 2016 (Coppedge et al., 2017a, 2017b). While V-Dem primarily provides interval measures, many important research questions require crisp regime measures."

### One methods/results paragraph that reports numbers (verbatim)
"Finally, a comparison of disagreements with extant datasets (7%–12% of the country-years), demonstrates that the RoW classification is more conservative, classifying regimes with electoral manipulation and infringements of the political freedoms more frequently as electoral autocracies, suggesting that it better captures the opaqueness of contemporary autocracies."

---

## 4. Waldner and Lust (2018), Annual Review of Political Science 21: 93–113 — "Unwelcome Change: Coming to Terms with Democratic Backsliding"
URL: https://www.annualreviews.org/doi/10.1146/annurev-polisci-050517-114628
...
### First paragraphs of the introduction (verbatim)
"Is global democracy under threat? Diamond (2008) warned of a democratic recession almost a decade ago, and in its 2016 report, Freedom House (2016) documents the tenth consecutive year of decline in global freedom. Countries with net declines in their aggregate score have outnumbered countries with a net increase in their aggregate score, often by a considerable margin. Leading scholars dissent from this pessimism, however. Many note that the Third Wave of democracy has featured few instances of democratic breakdown, and even these tend to be concentrated in the first decade of the Third Wave. Levitsky & Way (2015), for instance, point out that four democracy indices record stable average democracy scores over the past decade, while the number of democracies in the world has moved little in either absolute or relative terms. Both views may be correct."

### One discussion paragraph (verbatim)
"Both views may be correct. Related and noteworthy trends suggest that the health of global democracy can no longer be adequately measured by simply counting democracies and autocracies. First, the link between economic prosperity and democracy has been sharply attenuated over the past several decades. The price of admission to the club of democracies has presumably fallen, and it has become cheaper, in economic terms, to remain democratic."
</style_exemplars>
...
Output the result as JSON to: `/ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace/.sdk_openhands_agent_struct_out.json`
...
IMPORTANT: this task is NOT complete until `/ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace/.sdk_openhands_agent_struct_out.json` exists and contains JSON matching the schema above.
````

### [2] HUMAN-USER prompt · 2026-09-05 12:29:17 UTC
...
### [3] SKILL-INPUT — aii-paper-to-latex · 2026-09-05 12:29:25 UTC
...
### [4] SKILL-INPUT — aii-semscholar-bib · 2026-09-05 12:29:25 UTC
...
### [5] SYSTEM-USER prompt · 2026-09-05 12:41:20 UTC
...
{
  "command": "pip install --quiet pymupdf 2>&1 | tail -2; python3 -c \"import fitz; print('pymupdf', fitz.version)\"",
  "is_input": false,
  "timeout": 240.0,
  "reset": false
}
...
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "includegraphics in paper.tex: 0\nfigures available: 0\n-rw-r--r--  1 root root 290908 Sep  5 12:40 paper.pdf\n-rw-r--r--+ 1 root root  82626 Sep  5 12:40 paper.tex\n-rw-------  1 root root  13064 Sep  5 12:39 refere
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "[notice] A new release of pip is available: 25.0.1 -> 26.2.1\n[notice] To update, run: pip install --upgrade pip\nwarning: The `fitz` API is deprecated and will be removed in future. Use `import pymupdf` instead.\np
  - [agent_think]: - includegraphics count: 0 = 0 available figures. ✓
- paper.pdf exists, 290 KB. ✓
- Only 2 minor overfull hboxes (7pt and 14pt too wide — from bold lead-in paragraphs with long words "underwrite"/"consequential"; these are cosmetic and typical; the 14pt one is a bit wide. I can fix by allowing hyphe
  - [agent_response]: TODO 4 verified: 0 includegraphics == 0 figures. Now rendering all 24 pages for visual review.
  - [agent_tool_call] terminal: Tool: terminal
{
  "command": "cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace && mkdir -p review && python3 - << 'PYEOF'\nimport fitz\ndoc = fitz.open(\"paper.pdf\")\nprint(\"pages:\", doc.page_count)\nfor i, page in enumerate(doc):\n    pix = page.
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "Cannot execute multiple commands at once.\nPlease run each command separately OR chain them into a single command via && or ;\nProvided commands:\n(1) cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/
  - [agent_tool_call] terminal: Tool: terminal
{
  "command": "cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace && mkdir -p review && python3 - << 'PYEOF'\nimport fitz\ndoc = fitz.open(\"paper.pdf\")\nprint(\"pages:\", doc.page_count)\nfor i, page in enumerate(doc):\n    pix = page.
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "warning: The `fitz` API is deprecated and will be removed in future. Use `import pymupdf` instead.\npages: 24\nrendered"}], "is_error": false, "command": "cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_r
  - [agent_tool_call] terminal: Tool: terminal
{
  "command": "ls /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace/review/",
  "is_input": false,
  "timeout": null,
  "reset": false
}
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "page_01.png  page_03.png  page_05.png  page_07.png  page_09.png  page_11.png  page_13.png  page_15.png  page_17.png  page_19.png  page_21.png  page_23.png\npage_02.png  page_04.png  page_06.png  page_08.png  page_10
  - [agent_think]: 24 pages rendered. Now I need to READ the pages. Each page image costs ~1,600 tokens — 24 pages ≈ 38K tokens. That's affordable. However — I don't have a vision tool in this environment! Let me check my available tools... I have: terminal, file_editor, task_tracker, think, invoke_skill, finish. Ther
  - [agent_response]: 24 pages rendered. I don't have a direct image-viewing tool in this conversation, so I'll do a rigorous programmatic visual review: OCR each page plus geometric layout checks (margins, overlaps, clipping). Checking OCR tooling first.
  - [agent_tool_call] terminal: Tool: terminal
{
  "command": "which tesseract; tesseract --version 2>&1 | head -1; pip list 2>/dev/null | grep -i -E \"pytesseract|pillow|opencv\"",
  "is_input": false,
  "timeout": 60.0,
  "reset": false
}
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "bash: tesseract: command not found\npillow                                   12.3.0"}], "is_error": false, "command": "which tesseract; tesseract --version 2>&1 | head -1; pip list 2>/dev/null | grep -i -E \"pytesse
  - [agent_think]: No tesseract. But the PDF is a TEXT pdf (vector), so pymupdf text extraction is lossless — better than OCR. I'll do:

1. **Geometric layout checks** (pymupdf): 
   - Page count, per-page text block bounding boxes: ensure no block extends beyond page margins (x0 < 72-10 or x1 > 612-72+10 → flag), i.e
  - [agent_response]: The PDF is vector text, so pymupdf extraction is lossless — better than OCR. Running geometric layout checks (margins, overflows, overlaps) plus per-page ink coverage.
  - [agent_tool_call] terminal: Tool: terminal
{
  "command": "cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace && python3 - << 'PYEOF'\nimport fitz\nfrom PIL import Image\nimport numpy as np\n\ndoc = fitz.open(\"paper.pdf\")\nW, H = 612.0, 792.0\nML, MR, MT, MB = 72.0, 72.0, 72.0, 
  - [agent_tool_result] terminal: Tool: terminal
Result:
{"content": [{"cache_prompt": false, "type": "text", "text": "cd /ai-inventor/aii_data/runs/run_2nz_vV2E7aIl/4_gen_paper_repo/_4_assemble_paper/paper/workspace && python3 - << 'PYEOF'\nimport fitz\nfrom PIL import Image\nimport numpy as np\ndoc = fitz.open(\"paper.pdf\")\nW, H
